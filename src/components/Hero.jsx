...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-accent-50 to-gray-100 overflow-hidden">
      {/* Full-section SVG Backgrounds */}
      <svg className="absolute top-0 left-0 w-full h-full object-cover" viewBox="0 0 1440 320" fill="none" xmlns="http://www.w3.org/2000/svg" style={{zIndex:1}} preserveAspectRatio="none">
      ...
      <svg className="absolute bottom-0 left-0 w-full h-full object-cover" viewBox="0 0 1440 320" fill="none" xmlns="http://www.w3.org/2000/svg" style={{zIndex:1}} preserveAspectRatio="none">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight bg-gradient-to-r from-primary via-accent-700 to-accent-400 bg-clip-text text-transparent">
        ...
        <a
          href="#contact"
          className="inline-block px-8 py-3 relative font-semibold rounded-full group focus:outline-none focus:ring-2 focus:ring-primary/60 ring-offset-2"
        >
